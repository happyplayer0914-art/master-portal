...
const GameData = {
    items: {
      // 🟢 일반 (Common) - 초반용 깡스탯 위주
        'w_c1': { id: 'w_c1', type: 'gear', subType: 'weapon', name: '낡은 철검', emoji: '🗡️', image: 'assets/items/w_c1.png', rarity: 'common', color: 'text-slate-400', atkMult: 1.15 },
        'w_c2': { id: 'w_c2', type: 'gear', subType: 'weapon', name: '녹슨 단검', emoji: '🔪', image: 'assets/items/w_c2.png', rarity: 'common', color: 'text-slate-400', atkMult: 1.05, critRate: 5 },
        'w_c3': { id: 'w_c3', type: 'gear', subType: 'weapon', name: '거친 몽둥이', emoji: '🏏', image: 'assets/items/w_c3.png', rarity: 'common', color: 'text-slate-400', atkMult: 1.15 }, 
        
        'a_c1': { id: 'a_c1', type: 'gear', subType: 'armor', name: '가죽 갑옷', emoji: '🦺', image: 'assets/items/a_c1.png', rarity: 'common', color: 'text-slate-400', hpMult: 1.10 },
        'a_c2': { id: 'a_c2', type: 'gear', subType: 'armor', name: '빛바랜 천옷', emoji: '👕', image: 'assets/items/a_c2.png', rarity: 'common', color: 'text-slate-400', hpMult: 1.12, eva: 2 }, 
        'a_c3': { id: 'a_c3', type: 'gear', subType: 'armor', name: '나무 방패', emoji: '👕', image: 'assets/items/a_c3.png', rarity: 'common', color: 'text-slate-400', hpMult: 1.12, eva: 2 }, 
        
        
        'ac_c1': { id: 'ac_c1', type: 'gear', subType: 'accessory', name: '평범한 반지', emoji: '💍', image: 'assets/items/ac_c1.png', rarity: 'common', color: 'text-slate-400', atkMult: 1.05, hpMult: 1.05 },
        'ac_c2': { id: 'ac_c2', type: 'gear', subType: 'accessory', name: '행운의 동전', emoji: '🪙', image: 'assets/items/ac_c2.png', rarity: 'common', color: 'text-slate-400', atkMult: 1.02, critRate: 3 }, 

        // 🔵 희귀 (Rare) - 약간의 특성 부여 (공속, 회피, 방어력 등 등장)
        'w_r1': { id: 'w_r1', type: 'gear', subType: 'weapon', name: '기사단의 롱소드', emoji: '⚔️', image: 'assets/items/w_r1.png', rarity: 'rare', color: 'text-blue-400', atkMult: 1.25, def: 5 }, 
        'w_r2': { id: 'w_r2', type: 'gear', subType: 'weapon', name: '암살자의 비수', emoji: '🗡️', image: 'assets/items/w_r2.png', rarity: 'rare', color: 'text-blue-400', atkMult: 1.15, critRate: 15, critDmg: 20 },
        'w_r3': { id: 'w_r3', type: 'gear', subType: 'weapon', name: '사냥꾼의 뿔활', emoji: '🏹', image: 'assets/items/w_r3.png', rarity: 'rare', color: 'text-blue-400', atkMult: 6.20, spd: 50 }, 
        
        'a_r1': { id: 'a_r1', type: 'gear', subType: 'armor', name: '강철 방패', emoji: '🛡️', image: 'assets/items/a_r1.png', rarity: 'rare', color: 'text-blue-400', hpMult: 1.30, def: 10 }, 
        'a_r2': { id: 'a_r2', type: 'gear', subType: 'armor', name: '쇠사슬 갑옷', emoji: '🧥', image: 'assets/items/a_r2.png', rarity: 'rare', color: 'text-blue-400', hpMult: 1.15, vamp: 2 },
        'a_r3': { id: 'a_r3', type: 'gear', subType: 'armor', name: '도적의 망토', emoji: '🧣', image: 'assets/items/a_r3.png', rarity: 'rare', color: 'text-blue-400', hpMult: 1.20, eva: 8 }, 
        
        'ac_r1': { id: 'ac_r1', type: 'gear', subType: 'accessory', name: '수호의 목걸이', emoji: '📿', image: 'assets/items/ac_r1.png', rarity: 'rare', color: 'text-blue-400', atkMult: 1.10, hpMult: 1.15, def: 5 }, 
        'ac_r2': { id: 'ac_r2', type: 'gear', subType: 'accessory', name: '바람의 장화', emoji: '🥾', image: 'assets/items/ac_r2.png', rarity: 'rare', color: 'text-blue-400', hpMult: 1.10, spd: 10, eva: 3 }, 
        'ac_r3': { id: 'ac_r3', type: 'gear', subType: 'accessory', name: '투사의 증표', emoji: '🏅', image: 'assets/items/ac_r3.png', rarity: 'rare', color: 'text-blue-400', atkMult: 1.15, hpMult: 1.05, critDmg: 25 }, 
        
        
        // 🟣 영웅 (Epic) - 뚜렷한 컨셉 (크리 몰빵, 피흡 좀비, 쾌속 딜러 등)
        'w_e1': { id: 'w_e1', type: 'gear', subType: 'weapon', name: '마력의 지팡이', emoji: '🪄', image: 'assets/items/w_e1.png', rarity: 'epic', color: 'text-purple-400', atkMult: 1.50, critRate: 10, def: 10 },
        'w_e2': { id: 'w_e2', type: 'gear', subType: 'weapon', name: '그림자 낫', emoji: '🪝', image: 'assets/items/w_e2.png', rarity: 'epic', color: 'text-purple-400', atkMult: 1.30, critRate: 25, critDmg: 50 },
        'w_e3': { id: 'w_e3', type: 'gear', subType: 'weapon', name: '흡혈귀의 이빨 단검', emoji: '🦇', image: 'assets/items/w_e3.png', rarity: 'epic', color: 'text-purple-400', atkMult: 1.35, vamp: 8, spd: 5 }, 
        'w_e4': { id: 'w_e4', type: 'gear', subType: 'weapon', name: '강철의 대검', emoji: '🦇', image: 'assets/items/w_e4.png', rarity: 'epic', color: 'text-purple-400', atkMult: 1.35, vamp: 8, spd: 5 }, 
        
        'a_e1': { id: 'a_e1', type: 'gear', subType: 'armor', name: '성기사의 성갑', emoji: '🛡️', image: 'assets/items/a_e1.png', rarity: 'epic', color: 'text-purple-400', hpMult: 1.60, def: 15 }, 
        'a_e2': { id: 'a_e2', type: 'gear', subType: 'armor', name: '망령의 망토', emoji: '👻', image: 'assets/items/a_e2.png', rarity: 'epic', color: 'text-purple-400', hpMult: 1.30, vamp: 5, critRate: 10, eva: 8 },
        'a_e3': { id: 'a_e3', type: 'gear', subType: 'armor', name: '닌자의 수의', emoji: '🥷', image: 'assets/items/a_e3.png', rarity: 'epic', color: 'text-purple-400', hpMult: 1.25, eva: 15, spd: 15 }, 
        'a_e4': { id: 'a_e4', type: 'gear', subType: 'armor', name: '정령의 방패', emoji: '🥷', image: 'assets/items/a_e4.png', rarity: 'epic', color: 'text-purple-400', hpMult: 1.25, eva: 15, spd: 15 }, 
        
        'ac_e1': { id: 'ac_e1', type: 'gear', subType: 'accessory', name: '마나의 귀걸이', emoji: '💎', image: 'assets/items/ac_e1.png', rarity: 'epic', color: 'text-purple-400', atkMult: 1.25, hpMult: 1.25, def: 10 },
        'ac_e2': { id: 'ac_e2', type: 'gear', subType: 'accessory', name: '광전사의 뿔피리', emoji: '📯', image: 'assets/items/ac_e2.png', rarity: 'epic', color: 'text-purple-400', atkMult: 1.45, hpMult: 1.05, spd: 20 }, 
        'ac_e3': { id: 'ac_e3', type: 'gear', subType: 'accessory', name: '세계수의 잎사귀', emoji: '🍃', image: 'assets/items/ac_e3.png', rarity: 'epic', color: 'text-purple-400', hpMult: 1.40, vamp: 10, eva: 5 }, 
        
        

        // 🟡 전설 (Legendary) - 사기적인 능력치!
        'w_l1': { id: 'w_l1', type: 'gear', subType: 'weapon', name: '전설의 엑스칼리버', emoji: '🗡️', image: 'assets/items/w_l1.png', rarity: 'legendary', color: 'text-yellow-400', atkMult: 2.20, critRate: 20, critDmg: 50, def: 10 },
        'w_l2': { id: 'w_l2', type: 'gear', subType: 'weapon', name: '파멸의 마검', emoji: '🗡️', image: 'assets/items/w_l2.png', rarity: 'legendary', color: 'text-yellow-400', atkMult: 1.80, critRate: 40, critDmg: 100, spd: 15 },
        'w_l3': { id: 'w_l3', type: 'gear', subType: 'weapon', name: '피의 군주의 지팡이', emoji: '🩸', image: 'assets/items/w_l3.png', rarity: 'legendary', color: 'text-yellow-400', atkMult: 1.90, vamp: 15, eva: 10 },
        
        'a_l1': { id: 'a_l1', type: 'gear', subType: 'armor', name: '절대자의 황금 갑옷', emoji: '🛡️', image: 'assets/items/a_l1.png', rarity: 'legendary', color: 'text-yellow-400', hpMult: 2.50, def: 20 },
        'a_l2': { id: 'a_l2', type: 'gear', subType: 'armor', name: '불사의 심장', emoji: '❤️‍🔥', image: 'assets/items/a_l2.png', rarity: 'legendary', color: 'text-yellow-400', hpMult: 1.90, vamp: 12, def: 15 },
        'a_l3': { id: 'a_l3', type: 'gear', subType: 'armor', name: '환영의 거울 갑옷', emoji: '🪞', image: 'assets/items/a_l3.png', rarity: 'legendary', color: 'text-yellow-400', hpMult: 2.10, eva: 25, spd: 20 }, 
